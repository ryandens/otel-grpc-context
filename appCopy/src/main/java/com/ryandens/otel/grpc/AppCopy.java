...
public class AppCopy {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
      final int port = 8081;
      Server server = ServerBuilder.forPort(port).addService(new GreeterCopyImplBase() {
          @Override
            public void sayHelloCopy(CopyRequest request, StreamObserver<CopyResponse> responseObserver) {
